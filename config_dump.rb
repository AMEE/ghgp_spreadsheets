  calculation {
    ...
    profile {
      ...
      path 'NRG'
      default_unit :TJ
      alternative_units :J, :kWh, :MJ, :GJ, :BTU_FiftyNineF, :MBTU_FiftyNineF, :MWh, :TJ
      unit :TJ
      type :decimal
      interface :text_box
    ...
    output {
      ...
      path 'CH4'
      default_unit :kg
      alternative_units :g, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :kg
      unit :kg
  ...
  calculation {
    ...
    profile {
      ...
      path 'mass'
      default_unit :Gg
      alternative_units :kg, :g, :oz, :lb, :t, :Mg, :ton_us, :ton_uk, :Gg
      unit :Gg
      type :decimal
      interface :text_box
  ...
  calculation {
    ...
    profile {
      ...
      path 'volume'
      default_unit :m³
      alternative_units :L, :bbl, :oz_fl_uk, :gal_uk, :gallon_dry_us, :oz_fl, :bbl_fl_us, :gal, :m³
      unit :m³
      type :decimal
      interface :text_box
  ...
  calculation {
    ...
    profile {
      ...
      default_per_unit :kg
      alternative_units :g, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :kg
      alternative_per_units :g, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :kg
      unit :kg
      per_unit :kg
      type :decimal
      interface :text_box
    ...
    profile {
      ...
      default_unit :g
      default_per_unit :t
      alternative_units :kg, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :g
      alternative_per_units :kg, :g, :oz, :lb, :Gg, :ton_us, :ton_uk, :t
      unit :g
      per_unit :t
      type :decimal
      interface :text_box
  ...
  calculation {
    ...
    profile {
      ...
      path 'NRG'
      default_unit :TJ
      alternative_units :J, :kWh, :MJ, :GJ, :BTU_FiftyNineF, :MBTU_FiftyNineF, :MWh, :TJ, :TJ
      unit :TJ
      type :decimal
      interface :text_box
      note 'Specify the quantity of fuel consumed during the reporting period in terms of a quantity of energy'
    ...
    output {
      ...
      path 'CH4'
      default_unit :kg
      alternative_units :g, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :kg, :kg
      unit :kg
      note 'CH4 emissions calculated based on data entered for each scenario.'
    }
  ...
  calculation {
    ...
    profile {
      ...
      path 'mass'
      default_unit :Gg
      alternative_units :kg, :g, :oz, :lb, :t, :Mg, :ton_us, :ton_uk, :Gg, :Gg
      unit :Gg
      type :decimal
      interface :text_box
      note 'Specify the quantity of fuel consumed during the reporting period in terms of a mass-based quantity'
  ...
  calculation {
    ...
    profile {
      ...
      path 'volume'
      default_unit :m³
      alternative_units :L, :bbl, :oz_fl_uk, :gal_uk, :gallon_dry_us, :oz_fl, :bbl_fl_us, :gal, :m³, :m³
      unit :m³
      type :decimal
      interface :text_box
      note 'Specify the quantity of fuel consumed during the reporting period in terms of a volume-based quantity'
  ...
  calculation {
    ...
    profile {
      ...
      default_per_unit :kg
      alternative_units :g, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :kg, :kg
      alternative_per_units :g, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :kg, :kg
      unit :kg
      per_unit :kg
      type :decimal
      interface :text_box
    ...
    profile {
      ...
      default_unit :g
      default_per_unit :t
      alternative_units :kg, :oz, :lb, :t, :Mg, :Gg, :ton_us, :ton_uk, :g, :g
      alternative_per_units :kg, :g, :oz, :lb, :Gg, :ton_us, :ton_uk, :t, :t
      unit :g
      per_unit :t
      type :decimal
      interface :text_box
